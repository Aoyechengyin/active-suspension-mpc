function u_cmd = per_corner_mpc_R2_2020(acc_body, vel_body, susp_defl, susp_vel, road_now, w1_ahead, w2_ahead, u_prev, pitch_deg)
%PER_CORNER_MPC_R2_2020 Right-rear 1 ms regionless e-MPC controller.
...
if isempty(inited)
    ...
    [calib_enabled, u_override, output_scale, post_settings] = empc_calibration_settings_2020('R2');
